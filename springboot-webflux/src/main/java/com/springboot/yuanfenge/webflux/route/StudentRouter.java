package com.springboot.yuanfenge.webflux.route;

import com.springboot.yuanfenge.webflux.handler.StudentHandler;
...
public class StudentRouter {
    ...
    @Bean RouterFunction<ServerResponse> routList(StudentHandler studentHandler){
