package iilibxc.aop.aspect;

import iilibxc.aop.annotation.SystemControllerLog;
import iilibxc.aop.annotation.SystemServiceLog;
import iilibxc.aop.utils.IPUtils;
...
//    private ActionService actionService;
    ...
    //Controller层切点
    @Pointcut("@annotation(iilibxc.aop.annotation.SystemControllerLog)")
    public void controllerAspect() {
    }

    //Service层切点
    @Pointcut("@annotation(iilibxc.aop.annotation.SystemServiceLog)")
