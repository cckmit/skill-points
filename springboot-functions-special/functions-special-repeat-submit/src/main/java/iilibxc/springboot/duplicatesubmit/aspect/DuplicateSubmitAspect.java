package iilibxc.springboot.duplicatesubmit.aspect;

import iilibxc.springboot.duplicatesubmit.annotation.DuplicateSubmitToken;
import iilibxc.springboot.duplicatesubmit.constant.TextConstants;
import iilibxc.springboot.duplicatesubmit.exception.DuplicateSubmitException;
...
public class DuplicateSubmitAspect {
    ...
    @Pointcut("execution(public * iilibxc.springboot.duplicatesubmit.controller..*(..))")
