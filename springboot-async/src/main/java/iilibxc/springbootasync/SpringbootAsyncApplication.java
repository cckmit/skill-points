package iilibxc.springbootasync;

import iilibxc.springbootasync.service.TestService;
...
public class SpringbootAsyncApplication {
    ...
    public ApplicationRunner applicationRunner() {
        return applicationArguments -> {
            ...
            //有返回值，但主线程不需要用到返回值
            Future<String> future = testService.asyncTask("iilibxc");
            //有返回值，且主线程需要用到返回值
            System.out.println(Thread.currentThread().getName() + "：返回值：" + testService.asyncTask("iilibxc").get());
