package iilibxc.springbootjpa.util;
...
public class CodeDOM {
    ...
    private CodeDOM(String tableName) {
        ...
        basePackage_ = "iilibxc\\springbootjpa\\";
     ...
     * 数据连接相关
     */
    private static final String URL = "jdbc:mysql://localhost:3306/root?serverTimezone=GMT%2B8&characterEncoding=utf-8";
