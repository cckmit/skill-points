package iilibxc.springbootmybatisplus.util;
...
public class CodeGenerator {
	 ...
	 * 数据库连接url
	 */
	private static final String DB_URL = "jdbc:mysql://localhost:3306/root?serverTimezone=GMT%2B8&characterEncoding=utf-8";
